    ...
    return (
        ...
        >
            ...
            <div className="flex h-[90%] w-full flex-col items-end gap-2 md:h-[92%]">
                ...
                />
                <button
                    className="flex w-full justify-center rounded-md bg-blue-500 hover:bg-blue-600 p-2 font-bold text-white outline-none disabled:cursor-not-allowed disabled:opacity-50"
                    onClick={runCode}
                    disabled={isRunning}
                >
                    Run

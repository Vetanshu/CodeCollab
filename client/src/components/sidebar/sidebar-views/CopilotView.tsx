...
function CopilotView() {
    ...
    return (
        ...
        >
            ...
            />
            <button
                className="mt-1 flex w-full justify-center rounded-md bg-blue-500 p-2 hover:bg-blue-600 font-bold text-white outline-none disabled:cursor-not-allowed disabled:opacity-50"
